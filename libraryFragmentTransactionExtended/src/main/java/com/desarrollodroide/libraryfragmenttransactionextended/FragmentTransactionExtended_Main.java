...
public class FragmentTransactionExtended_Main {
    ...
    public FragmentTransactionExtended_Main(Context context, FragmentTransaction fragmentTransaction, Fragment firstFragment, Fragment secondFragment, int containerID) {
